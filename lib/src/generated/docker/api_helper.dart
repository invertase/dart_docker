...
String parameterToString(dynamic value) {
  ...
  if (value is ChangeType) {
    return ChangeTypeTypeTransformer().encode(value).toString();
  }
  if (value is LocalNodeState) {
    return LocalNodeStateTypeTransformer().encode(value).toString();
  }
  if (value is NodeState) {
    return NodeStateTypeTransformer().encode(value).toString();
  }
  if (value is Reachability) {
    return ReachabilityTypeTransformer().encode(value).toString();
  }
