...
class Swarm {
  ...
  int get hashCode =>
      ...
      (joinTokens == null ? 0 : joinTokens!.hashCode);

  @override
  String toString() =>
      'Swarm[ID=$ID, version=$version, createdAt=$createdAt, updatedAt=$updatedAt, spec=$spec, tLSInfo=$tLSInfo, rootRotationInProgress=$rootRotationInProgress, dataPathPort=$dataPathPort, defaultAddrPool=$defaultAddrPool, subnetSize=$subnetSize, joinTokens=$joinTokens]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.joinTokens != null) {
      json[r'JoinTokens'] = this.joinTokens;
    } else {
      json[r'JoinTokens'] = null;
    }
    return json;
  }

  /// Returns a new [Swarm] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static Swarm? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "Swarm[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "Swarm[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return Swarm(
        ...
        joinTokens: JoinTokens.fromJson(json[r'JoinTokens']),
      );
    }
    return null;
  }

  static List<Swarm> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <Swarm>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = Swarm.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, Swarm> mapFromJson(dynamic json) {
    final map = <String, Swarm>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = Swarm.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<Swarm>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final map = <String, List<Swarm>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = Swarm.listFromJson(
          entry.value,
          growable: growable,
        );
      }
