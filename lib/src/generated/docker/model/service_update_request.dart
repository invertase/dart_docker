...
class ServiceUpdateRequest {
  /// Returns a new [ServiceUpdateRequest] instance.
  ...
  @override
  String toString() =>
      'ServiceUpdateRequest[name=$name, labels=$labels, taskTemplate=$taskTemplate, mode=$mode, updateConfig=$updateConfig, rollbackConfig=$rollbackConfig, networks=$networks, endpointSpec=$endpointSpec]';
  ...
  /// Returns a new [ServiceUpdateRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ServiceUpdateRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "ServiceUpdateRequest[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "ServiceUpdateRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ServiceUpdateRequest> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <ServiceUpdateRequest>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ServiceUpdateRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ServiceUpdateRequest> mapFromJson(dynamic json) {
    final map = <String, ServiceUpdateRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ServiceUpdateRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ServiceUpdateRequest-objects as value to a dart map
  static Map<String, List<ServiceUpdateRequest>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final map = <String, List<ServiceUpdateRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ServiceUpdateRequest.listFromJson(
          entry.value,
          growable: growable,
        );
      }
