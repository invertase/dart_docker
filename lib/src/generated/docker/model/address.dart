...
class Address {
  ...
  bool operator ==(Object other) =>
      ...
      other is Address && other.addr == addr && other.prefixLen == prefixLen;

  @override
  int get hashCode =>
      // ignore: unnecessary_parenthesis
      (addr == null ? 0 : addr!.hashCode) +
      (prefixLen == null ? 0 : prefixLen!.hashCode);

  @override
  String toString() => 'Address[addr=$addr, prefixLen=$prefixLen]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.prefixLen != null) {
      json[r'PrefixLen'] = this.prefixLen;
    } else {
      json[r'PrefixLen'] = null;
    }
    return json;
  }
  ...
  static Address? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Address(
        ...
        prefixLen: mapValueOfType<int>(json, r'PrefixLen'),
      );
    }
    return null;
  }
