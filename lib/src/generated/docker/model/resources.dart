...
class Resources {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "Resources[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "Resources[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<Resources> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<Resources>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = Resources.listFromJson(
          entry.value,
          growable: growable,
        );
      }
