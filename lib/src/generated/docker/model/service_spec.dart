...
class ServiceSpec {
  /// Returns a new [ServiceSpec] instance.
  ServiceSpec({
    this.name,
    this.labels = const {},
    this.taskTemplate,
  ...
  @override
  String toString() =>
      'ServiceSpec[name=$name, labels=$labels, taskTemplate=$taskTemplate, mode=$mode, updateConfig=$updateConfig, rollbackConfig=$rollbackConfig, networks=$networks, endpointSpec=$endpointSpec]';
  ...
  /// Returns a new [ServiceSpec] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ServiceSpec? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "ServiceSpec[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "ServiceSpec[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ServiceSpec> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <ServiceSpec>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ServiceSpec.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ServiceSpec> mapFromJson(dynamic json) {
    final map = <String, ServiceSpec>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ServiceSpec.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<ServiceSpec>> mapListFromJson(
    ...
    final map = <String, List<ServiceSpec>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ServiceSpec.listFromJson(
          entry.value,
          growable: growable,
        );
      }
